...
var idAdmin="";
var personasCola="0";
var adminOcupado="0" // 0=NO 1=SI (hablando con otra persona)
...
easyrtc.setPeerListener( function(otroEasyrtcId, tipoMensaje, mensaje, targeting) {
        console.log("From " + easyrtc.idToName(otroEasyrtcId) + " sent the following data " + mensaje);
        idAdmin = mensaje;
        console.log("El id del ADMIN=" + idAdmin);
}, "autentificacion");

easyrtc.setPeerListener( function(otroEasyrtcId, tipoMensaje, mensaje, targeting) {
        personasCola = mensaje;
        console.log("Delante de mi en la cola hay: " + personasCola + " personas.");
}, "cola", idAdmin);

easyrtc.setPeerListener( function(otroEasyrtcId, tipoMensaje, mensaje, targeting) {
        if (mensaje=="1") {
            console.log("ADMINISTRADOR OCUPADO");
        } else {
            console.log("ADMINISTRADOR LIBRE");
        }
}, "ocupado", idAdmin);

easyrtc.setPeerListener( function(otroEasyrtcId, tipoMensaje, mensaje, targeting) {
        personasCola = mensaje;
        console.log("---------------------------------------------------->¡UPDATE¡ Delante de mi en la cola hay: " + personasCola + " personas.");
}, "update_cola", idAdmin);
